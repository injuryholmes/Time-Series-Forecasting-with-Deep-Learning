...
from utils.data_sp500_raw import SP500
...
if __name__ == "__main__":
    ...
    for i in range(cfg.max_epochs):
        ...
        mselosses.append(np.mean(loss_epoch))
    ...
    ax.plot(x, mselosses, color="red", label="train mape",marker="o")
    ...
    # ax.set_ylabel("test loss",color="blue",fontsize=14)
    plt.legend(loc='upper right')
    plt.savefig("Sp mape raw"+str(cfg.lookbackwindow)+".png",bbox_inches = 'tight')
    plt.show()

    # fig,ax = plt.subplots()
    # x = range(len(mselosses))
    # ax.plot(x, mselosses, color="red", label="train mse",marker="o")
    # ax.set_xlabel("epoch",fontsize=14)
    # ax.set_ylabel("train loss",color="red",fontsize=14)
    # plt.legend(loc='upper center')
    
    # ax2=ax.twinx()
    # ax2.plot(x, test_mses,color='blue',label="test mse",marker='v')
    # ax2.set_ylabel("test loss",color="blue",fontsize=14)
    # plt.legend(loc='upper right')
    # plt.savefig("Sp mse raw"+str(cfg.lookbackwindow)+".png",bbox_inches = 'tight')
    # plt.show()
