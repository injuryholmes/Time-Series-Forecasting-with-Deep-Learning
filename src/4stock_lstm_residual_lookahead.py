...
model = LSTM(hidden_size=200, num_securities=input_channels, dropout=cfg.dropout, n_layers=2, T=cfg.T)
...
if __name__ == "__main__":
    ...
    ax2=ax.twinx()
    ax2.plot(x, test_mses,color='blue',label="test mse")
    ax2.set_ylabel("test loss",color="blue",fontsize=14)
    plt.legend(loc='upper right')
    plt.savefig("SP LSTM LBW5.png",bbox_inches = 'tight')
    plt.show()
